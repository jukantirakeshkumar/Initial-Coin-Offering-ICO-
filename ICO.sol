...
contract ICO is Block{
    ...
    uint public icoEnd=block.timestamp+3600;//1hr=3600 sec

    uint public tokenTradeTime=icoEnd+3600;

    uint public maxInvest=10 ether;
    uint public minIvest=0.1 ether;
    ...
    function invest() payable public returns(bool){
        ...
        require(msg.value >= minIvest && msg.value <=maxInvest);
